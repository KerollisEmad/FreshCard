...
// handleAddingProductTowishlist()
  return (
    <>
    <PageMetadata 
    title="FreshCard | Wishlist - Your Saved Items"
    description="Manage your wishlist on FreshCard. Save your favorite products and easily add them to your cart when you're ready to purchase."
    author="FreshCard Team"
    keywords="FreshCard, wishlist, saved items, online shopping, grocery wishlist, add to cart"
    />
      <div className="bg-primary-50/40 py-15">
            ...
            <div className="md:col-span-7 lg:col-span-9 bg-white py-5 rounded-md border border-gray-300/70 w-full inline-block">
              <div className="border-b border-gray-300 pb-5 px-10">
                ...
                <div className="flex flex-col lg:flex-row space-y-2 justify-between items-center">
                  <p className="text-gray-500 mt-1">3 items in your wishlist</p>
